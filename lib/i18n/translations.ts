...
export const translations = {
  ja: {
    ...
    pricing: {
      ...
      noteLongStay: '💡 連泊割引あり（2泊:¥13,000、3〜4泊:¥12,000、5〜7泊:¥11,000、8泊以上:¥10,000）カレンダーで日程を選ぶと割引後の合計金額が自動表示されます',
  ...
  en: {
    ...
    pricing: {
      ...
      noteLongStay: '💡 Long-stay discounts auto-applied (2n: ¥13,000, 3-4n: ¥12,000, 5-7n: ¥11,000, 8n+: ¥10,000). Select dates to see total.',

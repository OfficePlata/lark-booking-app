...
export const translations = {
  ja: {
    ...
    pricing: {
      ...
      planName: 'スタンダードプラン',
      planDescription: '最大2名様まで・完全貸切（※3名様利用のご準備は現在進めております）',
      planPrice: '¥16,000~',
      planUnit: '/泊',
      additionalGuestNote: '※3名様利用のご準備は現在進めております',
      ...
      note3Guests: '※3名様利用のご準備は現在進めております',
      noteLongStay: '💡 連泊割引あり（2泊:¥13,000、3〜4泊:¥12,000、5〜7泊:¥11,000、8〜10泊:¥10,000、11泊以上:¥9,000）カレンダーで日程を選ぶと割引後の合計金額が自動表示されます',
  ...
  en: {
    ...
    pricing: {
      ...
      planDescription: 'Private apartment for up to 2 guests (3rd guest coming soon)',
      planPrice: '¥16,000~',
      planUnit: '/night',
      additionalGuestNote: '* Accommodation for 3 guests is coming soon',
      ...
      note3Guests: '* Accommodation for 3 guests is coming soon',
      noteLongStay: '💡 Long-stay discounts auto-applied (2n: ¥13,000, 3-4n: ¥12,000, 5-7n: ¥11,000, 8-10n: ¥10,000, 11n+: ¥9,000). Select dates to see total.',

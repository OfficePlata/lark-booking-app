...
export const BASE_CONFIG = {
  ...
  defaultRates: {
    ...
    8: 10000, // 8連泊時の単価 (2名分)
    9: 10000, // 9連泊時の単価 (2名分)
    10: 10000, // 10連泊時の単価 (2名分)
    11: 10000, // 11連泊時の単価 (2名分)
    12: 10000, // 12連泊時の単価 (2名分)
    13: 10000, // 13連泊時の単価 (2名分)
    14: 10000, // 14連泊時の単価 (2名分)
    15: 10000, // 15連泊時の単価 (2名分)
    16: 10000, // 16連泊時の単価 (2名分)
    17: 10000, // 17連泊時の単価 (2名分)
    18: 10000, // 18連泊時の単価 (2名分)
    19: 10000, // 19連泊時の単価 (2名分)
    20: 10000, // 20連泊時の単価 (2名分)

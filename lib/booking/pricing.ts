...
export const BASE_CONFIG = {
  ...
  defaultRates: {
    ...
    11: 9000, // 11連泊時の単価 (2名分)
    12: 9000, // 12連泊時の単価 (2名分)
    13: 9000, // 13連泊時の単価 (2名分)
    14: 9000, // 14連泊時の単価 (2名分)
    15: 9000, // 15連泊時の単価 (2名分)
    16: 9000, // 16連泊時の単価 (2名分)
    17: 9000, // 17連泊時の単価 (2名分)
    18: 9000, // 18連泊時の単価 (2名分)
    19: 9000, // 19連泊時の単価 (2名分)
    20: 9000, // 20連泊時の単価 (2名分)
